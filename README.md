...
1.  Add ddev to the project `dd config --php-version 8.3 --database mariadb:10.11` (most defaults are fine for projects without additional services like solr), use `drupal11` recipe
